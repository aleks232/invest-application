...
To build the final jar and optimize the InvestApplication application for production, run:
...
Then navigate to [http://localhost:8189](http://localhost:8189) in your browser.
